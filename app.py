...
st.markdown("""
    <div style="padding: 2rem; text-align: center; font-family: sans-serif;">
        ...
        <p style="color: #475569; font-weight: 600;">Sistema de control de novedades quincenales activo y actualizado.</p>
    </div>
    ...
    <script>
        ...
        function addRec() {
            ...
            records.push({
                ...
                incap: clean(incap), start: clean(document.getElementById('dateStart').value),
                end: clean(document.getElementById('dateEnd').value), days: clean(document.getElementById('dDays').value),
                val: clean(document.getElementById('dVal').value), obs: clean(document.getElementById('dObs').value),
